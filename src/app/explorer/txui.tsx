                        ...
                        <Table className="">
                            <TableBody className="divide-y">
                                ...
                                <TableRow className="dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <TableCell className="txui-cell-value w-screen break-words">
                                        { response.result.hex.substring(0,50) + " ... " + response.result.hex.substring(response.result.hex.length - 50)
                                        }
                                    </TableCell>
                                </TableRow>
                            </TableBody>
